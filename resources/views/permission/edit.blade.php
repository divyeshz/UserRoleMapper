            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="" id="editPermissionForm" method="post">
                            @csrf
                            <div class="mb-3">
                                <label class="form-label">Permission Name <span class="star">*</span> </label>
                                <input type="text" value="Permission" class="form-control" name="name"
                                    placeholder="Enter Permission name">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Description <span class="star">*</span> </label>
                                <textarea class="form-control" name="description" id="description" rows="5" placeholder="Enter Description">Permission</textarea>
                            </div>
